...
export default function Contact() {
  return (
    <div className='flex flex-col  md:flex-row pt-24 dark:bg-neutral'>
        
      
    <div className='flex flex-col self-center mx-16 mb-10 md:mb-0 w-64 md:w-80 h-full border-double border-4 border-primary dark:border-primary rounded-r-md" overflow-hidden w-96 shadow-3xl'>
