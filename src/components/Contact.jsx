...
export default function Contact() {
  return (
    <div className='flex justify-center dark:bg-neutral'>
    <div className='flex flex-col  m-12 border-double border-4 border-primary dark:border-white rounded-r-md" overflow-hidden w-96'>
