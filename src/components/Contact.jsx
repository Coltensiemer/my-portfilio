  ...
  >
    ...
    <div className='flex flex-col self-center md:relative md:bottom-32 md:left-0 mx-16 mb-10 md:mb-0 w-80 md:w-80 h-full bg-white dark:bg-neutral border-double border-4 border-primary dark:border-primary overflow-hidden  shadow-3xl'>
     ...
     <ul className='flex flex-col gap-4 pl-6'>
      <li className='self-start hover:text-primary dark:text-white dark:hover:text-primary'>(402)-740-3855</li>
      <li className='self-start hover:text-primary dark:text-white dark:hover:text-primary'>Colten50@hotmail.com</li>
      <li className='self-start hover:text-primary dark:text-white dark:hover:text-primary'>Chattanooga, Tn</li>
     </ul>
